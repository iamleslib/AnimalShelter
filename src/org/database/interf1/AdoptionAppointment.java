...
import org.database.interf1.AdoptingAnimal.ProceedButtonListener;

public class AdoptionAppointment extends JFrame {
	...
	private void buildPanel() {
		...
		animalDescription = new JLabel(animal + ", the animal you are trying to adopt is a " + species + ".\n" + "The format"
	...
	public class CreateButtonListener implements ActionListener
	   {
	      ...
	      if(numofappointments == 0) {
	    	  Shelter s = currentanimal.getShelter();
	    	  s.animalAwaitingAdoption(currentanimal);
	    	  String complete = "You have created your neccessary number of appointments.\n" + 
	      "The animal has been put on the waiting list and if your appoinments are succesful, you can adopt " + currentanimal.getName() + ".";
